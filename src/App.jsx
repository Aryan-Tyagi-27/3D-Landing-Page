    ...
    <div className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
        ...
        {/* <div className="absolute top-8 left-8 text-white">
          ...
          <p className="text-gray-400 text-lg mt-2">Move your mouse to control the geometry</p>
        </div> */}
        ...
        {/* <div className="absolute bottom-8 right-8 text-white text-right">
          <div className="bg-black bg-opacity-50 p-4 rounded-lg border border-cyan-500">
            ...
            <p className="text-sm text-gray-300 mb-1">Mouse X/Y → Object Position</p>
            <p className="text-sm text-gray-300 mb-1">Mouse Distance → Scale</p>
            <p className="text-sm text-gray-300">Camera follows cursor</p>
          </div>
        </div> */}
        
        {/* Decorative elements */}
        <div className="absolute top-1/4 right-16 w-2 h-2 bg-cyan-400 rounded-full animate-pulse"></div>
        <div className="absolute bottom-1/3 left-16 w-1 h-1 bg-blue-400 rounded-full animate-pulse"></div>
        <div className="absolute top-1/2 left-1/4 w-1.5 h-1.5 bg-cyan-300 rounded-full animate-pulse"></div>
      </div>
      
      {/* Gradient overlay for visual depth */}
      <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent pointer-events-none opacity-30"></div>
    </div>
  );
};
